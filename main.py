...
def choice_char_class() -> str:
    """Class selection for char."""
    approve_choice: str = None
    char_class: str = None
    char_class_selected: bool = False
    while approve_choice != 'y' or char_class_selected is False:
        char_class = input('Введи название персонажа, за которого'
                           'хочешь играть: Воитель — warrior, Маг — mage, '
                           'Лекарь — healer: ')
        if char_class == 'warrior':
            char_class_selected = True
